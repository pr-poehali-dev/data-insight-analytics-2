      ...
      <div className="relative z-10 flex min-h-screen items-center">
        <div className="container mx-auto px-8 md:px-16">
          <div className="flex max-w-2xl flex-col gap-8">
            ...
            >
              <div className="relative h-36 w-36 overflow-hidden rounded-full border-4 border-white/20 shadow-2xl md:h-48 md:w-48">
                <img
            ...
            >
              <div className="space-y-4">
                ...
                <p className="text-lg font-light text-white/70 md:text-xl">
                  Креативный специалист · Автор · Блогер
                </p>
                <p className="max-w-lg text-base leading-relaxed text-white/60">
                  Привет! Я занимаюсь созданием контента и делюсь своим опытом
                  в социальных сетях. Здесь вы найдёте мои каналы и способы
                  связаться со мной.
                </p>
              </div>
            </div>
            ...
            >
              <div className="flex flex-col gap-3">
                <a
                  ...
                  className="flex w-full max-w-sm items-center gap-4 rounded-xl border border-white/10 bg-white/5 px-5 py-3.5 backdrop-blur-sm transition-all hover:border-white/20 hover:bg-white/10"
                >
                  <svg className="h-6 w-6 shrink-0 text-[#26A5E4]" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex flex-col">
                    <span className="text-sm font-medium text-white">Telegram-канал</span>
                    <span className="text-xs text-white/50">Новости и обновления</span>
                  </div>
                  <Icon name="ArrowUpRight" size={18} className="ml-auto text-white/30" />
                </a>
                ...
                <a
                  ...
                  className="flex w-full max-w-sm items-center gap-4 rounded-xl border border-white/10 bg-white/5 px-5 py-3.5 backdrop-blur-sm transition-all hover:border-white/20 hover:bg-white/10"
                >
                  <svg className="h-6 w-6 shrink-0 text-[#0077FF]" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-xs text-white/50">Сообщество и общение</span>
                  </div>
                  <Icon name="ArrowUpRight" size={18} className="ml-auto text-white/30" />
                </a>
                ...
                <a
                  ...
                  className="flex w-full max-w-sm items-center gap-4 rounded-xl border border-white/10 bg-white/5 px-5 py-3.5 backdrop-blur-sm transition-all hover:border-white/20 hover:bg-white/10"
                >
                  <svg className="h-6 w-6 shrink-0 text-[#E4405F]" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-xs text-white/50">Фото и сторис</span>
                  </div>
                  <Icon name="ArrowUpRight" size={18} className="ml-auto text-white/30" />
                </a>
              </div>
            ...
            >
              <div className="flex items-center gap-4 pt-2">
                ...
                <span className="text-sm text-white/40">hello@example.com</span>
              </div>
            </div>
          </div>
        </div>
